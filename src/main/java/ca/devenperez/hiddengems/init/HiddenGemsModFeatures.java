...
import ca.devenperez.hiddengems.world.features.ores.MoonstoneOreFeature;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class HiddenGemsModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(MoonstoneOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				MoonstoneOreFeature.GENERATE_BIOMES, MoonstoneOreFeature.CONFIGURED_FEATURE));
	}
